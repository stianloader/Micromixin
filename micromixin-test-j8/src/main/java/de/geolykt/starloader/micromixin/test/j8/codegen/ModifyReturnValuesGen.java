...
public class ModifyReturnValuesGen {
    ...
    public static final String PACKAGE_MIXIN = "de.geolykt.starloader.micromixin.test.j8.mixin.mixinextra";
    public static final String PACKAGE_TARGET = "de.geolykt.starloader.micromixin.test.j8.targets.mixinextra";
